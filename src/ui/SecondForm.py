...
from .ThirdForm import ThirdForm

import sys
sys.path.append("..")

from constants.Constants import WindowColor, LuscherTestCur, ColorsDict, LuscherTestResult, Colors
