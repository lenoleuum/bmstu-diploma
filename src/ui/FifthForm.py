...
from .SixthForm import SixthForm

import sys
sys.path.append("..")

from constants.Constants import WindowColor, LuscherTestCur, ColorsDict, LuscherTestResult, Colors, LuscherTestCur
