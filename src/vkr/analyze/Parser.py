...
class Parser:
        ...
        for dir in data:
            ...
            for file in dir:
                ...
                try:
                    ...
                    self.handle_insertion(sound_object_to_insert, ('R', "0.25"))
                    self.handle_insertion(('R', "0.25"), first_sound_object)
                except:
                    continue
    ...
    def handle_insertion(self, prev_sound_object, sound_object_to_insert):
        if sound_object_to_insert is not None and sound_object_to_insert[0] is not None:
            ...
            if sound_object_to_insert not in self.states and sound_object_to_insert != ('R', "0.25"):
